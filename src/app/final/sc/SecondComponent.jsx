...
const CalificacionesSC = () => {
  ...
  const calcularTotal = () => {
    const primerExamenP = primerExamen * 0.25
    const segundoExamenP = segundoExamen * 0.25
    const examenFinalP = examenFinal * 0.40
    const evaluacionContinuaP = evaluacionContinua * 0.10
  ...
  return (
    <div className='max-w-md mx-auto p-6 mt-5 bg-white border-[0.1px]  border-slate-500 rounded-md shadow-xl'>
      ...
      <h3 className='text-xl font-medium mb-5 flex justify-center'>Tercer Cuatrimestre en adelante</h3>
      <div className='mb-4'>
...
export default CalificacionesSC
